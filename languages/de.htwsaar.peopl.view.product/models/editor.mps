...
<model ref="r:29a150a1-f788-4254-ba38-9c184bc1f289(de.htwsaar.peopl.view.product.editor)">
  ...
  <node concept="24kQdi" id="1DrSvX1D0en">
    ...
    <node concept="2SsqMj" id="3D9VpaLnKgQ" role="2wV5jI">
      <node concept="pkWqt" id="3D9VpaLnKgT" role="pqm2j">
        <node concept="3clFbS" id="3D9VpaLnKgU" role="2VODD2">
          <node concept="3clFbJ" id="3D9VpaLnKi2" role="3cqZAp">
            ...
            <node concept="2OqwBi" id="3D9VpaLoiTB" role="3clFbw">
              <node concept="2OqwBi" id="3D9VpaLoiJb" role="2Oq$k0">
                <node concept="2OqwBi" id="3D9VpaLoisX" role="2Oq$k0">
                  <node concept="pncrf" id="3D9VpaLoipC" role="2Oq$k0" />
                  <node concept="1mfA1w" id="3D9VpaLoiBH" role="2OqNvi" />
                </node>
                <node concept="3CFZ6_" id="3D9VpaLoiMQ" role="2OqNvi">
                  <node concept="3CFYIy" id="3D9VpaLoiPg" role="3CFYIz">
                    <ref role="3CFYIx" to="sj65:5BQdQAJnpSP" resolve="FragmentFillsVP" />
                  </node>
                </node>
              </node>
              <node concept="3x8VRR" id="3D9VpaLoj5Z" role="2OqNvi" />
            </node>
          </node>
        </node>
      </node>
