...
<model ref="r:8ad46a14-c03f-4e32-b089-ba8c393570d0(de.peopl.core.variabilityDeclaration.plugin)">
  ...
  <node concept="3vrhyV" id="2FVYQByNgQM">
    ...
    <node concept="1QGGSu" id="23vxL33svZr" role="3vqPLo">
      <property role="1iqoE4" value="${module}/icons/variability.png" />
    </node>
    <node concept="2V$Bhx" id="2FVYQByNgU9" role="QG$2i">
