...
<language namespace="de.peopl.core" uuid="1a3a0b62-fb00-47d1-8423-98da4001b216" languageVersion="0" moduleVersion="0">
  <models>
  ...
  <accessoryModels />
  <generators>
    <generator alias="" namespace="de.peopl.core#3071473864244849393" uuid="c9a56e63-3222-4b77-a7ff-0dd9a6ca29db">
      <models>
        <modelRoot contentPath="${module}" type="default">
      ...
      <dependencyVersions>
        ...
        <module reference="c9a56e63-3222-4b77-a7ff-0dd9a6ca29db(de.peopl.core#3071473864244849393)" version="0" />
  ...
  <dependencies>
    ...
    <dependency reexport="true">2e24a298-44d1-4697-baec-5c424fed3a3b(jetbrains.mps.editorlang.runtime)</dependency>
