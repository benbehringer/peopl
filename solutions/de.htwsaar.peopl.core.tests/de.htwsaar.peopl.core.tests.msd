...
<solution name="de.htwsaar.peopl.core.tests" uuid="714d1224-e4a9-43e5-bcdb-282cc134a34d" moduleVersion="0" pluginKind="PLUGIN_OTHER" compileInMPS="true">
  <models>
  ...
  <dependencyVersions>
    ...
    <module reference="714d1224-e4a9-43e5-bcdb-282cc134a34d(de.htwsaar.peopl.core.tests)" version="0" />
