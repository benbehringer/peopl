...
<model ref="r:b2f3d5f9-b81e-4589-95e8-d5be28f6e48f(com.mbeddr.mpsutil.projectview.views.plugin)">
  ...
  <node concept="14aYJB" id="$6jtTwOyRt">
    ...
    <node concept="Xl_RD" id="63CrThueI9b" role="3GFWDq">
      <property role="Xl_RC" value="mbeddr: Logical View by Concept" />
    </node>
  </node>
  <node concept="14aYJB" id="7diJr$RurxA">
    ...
    <node concept="Xl_RD" id="63CrThueHcL" role="3GFWDq">
      <property role="Xl_RC" value="mbeddr: Logical View Clone" />
    </node>
  </node>
