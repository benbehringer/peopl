...
<model ref="r:b16002b4-3e9f-4cda-b9e1-53c91cafb2e8(de.peopl.mBeddrExtension.structure)">
  ...
  <node concept="1TIwiD" id="5HPu$ZqJ8jv">
    ...
    <node concept="PrWs8" id="5HPu$ZqJ8tf" role="PzmwI">
      <ref role="PrY4T" to="vmgn:EpVRRuzuMu" resolve="DeprecatedModularCompilationUnit" />
    </node>
    <node concept="asaX9" id="7KoG6YFV9rq" role="lGtFl" />
  </node>
</model>
