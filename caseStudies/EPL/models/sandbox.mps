...
<model ref="r:03331478-e1fb-40a1-b695-9c48d61c0cad(sandbox)">
  ...
  <node concept="HxVAC" id="5fE_6DrTINu">
    <property role="wgJFU" value="myModule" />
    <property role="TrG5h" value="DLitAddPrint::Exp" />
    <property role="3GE5qa" value="tmp.basicModularity" />
    <ref role="HxVAF" to="fkj5:7A5hYwQxN8b" resolve="DLitAddPrint" />
    <ref role="HxVAD" node="7A5hYwQxN8X" resolve="Exp" />
  </node>
</model>
